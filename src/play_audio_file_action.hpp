...
class PlayAudioFileAction : public BT::RosServiceNode<PlayAudioFile>
{
public:
  explicit PlayAudioFileAction(const std::string& name, const BT::NodeConfig& conf,
                             const BT::RosNodeParams& params)
    : RosServiceNode<PlayAudioFile>(name, conf, params)
  {}
