...
bool GetPathToPose(rclcpp::Node::SharedPtr node, nav_msgs::msg::Path& path,
  ...
  rclcpp_action::ClientGoalHandle<
      nav2_msgs::action::ComputePathToPose>::SharedPtr goal_handle =
  ...
  rclcpp_action::ClientGoalHandle<
      nav2_msgs::action::ComputePathToPose>::WrappedResult wrapped_result =
      result_future.get();
  ...
  len = nav2_util::geometry_utils::calculate_path_length(
      wrapped_result.result->path, 0);
