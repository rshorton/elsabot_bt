...
bool ResumeAudioAction::setRequest(Request::SharedPtr& request)
{
...
BT::NodeStatus ResumeAudioAction::onResponseReceived(const Response::SharedPtr& response)
{
  RCLCPP_INFO(logger(), "ResumeAudioAction result received, result: %s",
              response->result.c_str());
  return BT::NodeStatus::SUCCESS;
}

BT::NodeStatus ResumeAudioAction::onFailure(BT::ServiceNodeErrorCode error)
{
