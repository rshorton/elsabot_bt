...
class RobotFindGame {
 ...
 public:
  ...
  bool Init(std::string game_data_file,
  ...
  bool GetObjectTypeNames(std::string object_type,
                          std::vector<std::string>& names);

  void GetAvePosition(position& ave_pos) {
    ave_pos.x = ave_x_;
    ave_pos.y = ave_y_;
  }
  void GetRobotPosition(double& x, double& y, double& yaw) {
    x = robot_pos_x_;
    y = robot_pos_y_;
    yaw = robot_yaw_;
  }
 ...
 private:
  ...
  // Map of object_type ("numbers", "shapes") to map of specific object vs.
  // floor position name objects_["numbers"] contains a map where the key is the
  // name of the number, the value is the name of the position
  //    map["1"] = "1"
  //    ...
  //    map["9"] = "9"
  // objects_["shapes"] contains a map where the key is the name of the shape,
  // the value is the name of the position
  //    map["heart"] = "1"
  //    ...
  //    map["triangle"] = "9"
