...
#define REGISTER_BUILDER_WITH_ROS_NODE(node_type, ros_node_handle)         \
  factory.registerBuilder<node_type>(                                      \
      #node_type, [ros_node_handle](const std::string& name,               \
...
int main(int argc, char** argv) {
  ...
  bool use_std_out_logger =
      nh->get_parameter("bt_use_std_out_logger").as_bool();
  ...
  factory.registerNodeType<GetRandomSelectionAction>(
  ...
  factory.registerNodeType<RobotSeekInBoundsCheckAction>(
      "RobotSeekInBoundsCheckAction");
  ...
  factory.registerNodeType<RobotFindCheckStepAction>(
      "RobotFindCheckStepAction");
  factory.registerNodeType<RobotFindSetPositionAction>(
      "RobotFindSetPositionAction");
  ...
  factory.registerNodeType<DetectionProcessorCreateAction>(
      "DetectionProcessorCreateAction");
  factory.registerNodeType<DetectionConfigureAction>(
      "DetectionConfigureAction");
  factory.registerNodeType<DetectionCommandAction>("DetectionCommandAction");
  factory.registerNodeType<DetectionGetPositionAction>(
  ...
  factory.registerNodeType<ArmGotoNamedPositionAction>(
      "ArmGotoNamedPositionAction");
  factory.registerNodeType<SetArmPositionAction>("SetArmPositionAction");
  factory.registerNodeType<SetGripperPositionAction>(
      "SetGripperPositionAction");
  ...
  factory.registerNodeType<ObjectTrackerStatusAction>(
      "ObjectTrackerStatusAction");

  factory.registerNodeType<RobotCatGameNextPoseAction>(
      "RobotCatGameNextPoseAction");
  ...
  // Remove after converting existing trees to use TextToSpeachAction
  ...
  // Create transform helper singleton. Used by various nodes for coordinate
  // transformation between robot frames
